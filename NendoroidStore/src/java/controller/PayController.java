...
public class PayController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DAO dao = new DAO();
            boolean checkUpdate = dao.buyProduct(bank.getBalance() - total, bank.getId());
            boolean updateStatus = dao.updateStatus(orderID);
            if (checkUpdate && updateStatus) {
                url = SUCCESS;
            } else {
                request.setAttribute("alert", "Failed to pay");
            }
        } catch (Exception e) {
